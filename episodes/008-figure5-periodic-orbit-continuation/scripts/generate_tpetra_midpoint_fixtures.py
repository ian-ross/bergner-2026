...
CASE_NAMES = ("n8_converged", "n8_nonsolution", "n64_converged", "n64_nonsolution")
    ...
    manifest = {
        ...
        "cases": {
            name: {
                ...
                "meaning": "accepted discrete solution" if name.endswith("converged")
                ...
                "upstream": "TASK-056 frozen arrays" if name.startswith("n64") else "TASK-059 deterministic N=8 correction",
            }
