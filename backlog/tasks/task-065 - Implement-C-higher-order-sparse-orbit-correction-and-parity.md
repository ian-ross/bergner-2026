...
- [ ] #2 C++ residuals, analytic Jacobian actions, phase rows, log-period columns, and normalized rho/T-hat parameter columns match frozen Python converged and nonsolution higher-order fixtures within versioned parity tolerances
- [ ] #3 Thyra/NOX with Amesos2 KLU2 corrects representative two- and three-stage fixed-parameter qualification orbits and independently enforces residual, phase, positivity, phase-energy, and linear-solve acceptance gates
