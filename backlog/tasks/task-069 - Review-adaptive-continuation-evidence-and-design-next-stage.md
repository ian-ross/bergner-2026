...
- [ ] #2 Every TASK-062 v1 hypothesis is dispositioned as retain, revise with evidence and method-version change, or defer; the review explicitly decides whether Radau, coarsening, landmark alignment, local hp, iterative solvers, or multibranch confirmation is warranted
